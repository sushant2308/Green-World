...
urlpatterns = [
    ...
    path('product_actions/<slug:slug>/', views.product_actions, name='productdetail'),#checked
    path('product_add/', views.add_product, name='productdetail'),#checked
    path('purchase/<slug:slug>/', views.purchase_product, name='purchase'),#checked
]
